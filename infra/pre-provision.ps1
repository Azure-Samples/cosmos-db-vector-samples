...
#   - User sets AZURE_COSMOSDB_CREATE_INDEX_DATABASENAME BEFORE azd up
...
if ($env:AZURE_COSMOSDB_CREATE_INDEX_DATABASENAME) {
    Write-Host ""
    Write-Host "📍 CREATE-INDEX scenario detected" -ForegroundColor Green
    Write-Host "   Database: $($env:AZURE_COSMOSDB_CREATE_INDEX_DATABASENAME)" -ForegroundColor Green
