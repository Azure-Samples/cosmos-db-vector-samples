...
# The presence/absence of AZURE_COSMOSDB_CREATE_INDEX_DATABASENAME determines the scenario
# This environment variable is set by the user at deployment time: $env:AZURE_COSMOSDB_CREATE_INDEX_DATABASENAME='HotelsCreateIndex'; azd up
