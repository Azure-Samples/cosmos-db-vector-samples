...
import { readFileReturnJson, writeFileJson, JsonData, getClientsPasswordless, validateFieldName } from "../utils.js";
...
try {
    ...
    const safeEmbeddedField = validateFieldName(newEmbeddedField);
