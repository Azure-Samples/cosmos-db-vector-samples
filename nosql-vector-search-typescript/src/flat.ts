/**
 * Flat Vector Index Demo for Azure Cosmos DB NoSQL
 * 
 * Flat (Brute-Force) indexing provides exact k-nearest neighbors (kNN) search
 * by computing distances to all vectors in the dataset.
 * 
 * Key Characteristics:
 * - Best for: Small to medium datasets, or queries with selective filters
 * - Accuracy: 100% recall (exact search)
 * - Performance: Linear scaling with dataset size
 * - Memory: All vectors loaded in memory
 * - Dimensions: Supports up to 505 dimensions
 * 
 * Use Cases:
 * - Small datasets where accuracy is critical
 * - Queries with partition key or WHERE filters that reduce candidate set
 * - Development and testing scenarios
 * - Scenarios requiring guaranteed exact matches
 */
...
async function main() {
    ...
    try {
        ...
        console.log('\n========================================');
        console.log('Flat Vector Index Demo (Exact Search)');
        console.log('========================================\n');
        ...
        // Create the indexing policy with Flat vector index
        // Flat provides 100% accurate results but is slower for large datasets
        ...
        console.log(`Container '${config.collectionName}' created with Flat index.\n`);
        ...
        // Display results
        console.log('========================================');
        console.log('Top 5 Results (Flat/Exact Index)');
        console.log('========================================\n');
        ...
        console.log('Note: Flat index provides 100% accurate results');
        console.log('but may be slower for large datasets.\n');
