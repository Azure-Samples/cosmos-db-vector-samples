...
def main() -> None:
    ...
    try:
        ...
        print("\nRunning searches (top {0} results)...".format(config.top_count))
        ...
        # --- Comparison table ---
        print()
        print("| {0:<14} | {1:<26} | {2:<6} | {3:<26} | {4:<6} | {5:<6} |".format(
        ...
        for label, summary in all_results:
            ...
            print("| {0:<14} | {1:<26} | {2:.4f} | {3:<26} | {4:.4f} | {5:.4f} |".format(
                label, top1_name[:26], top1_score, top2_name[:26], top2_score, diff))
