...
For the nosql-create-index-dotnet sample, the large vector data files are not stored in this folder to avoid duplicating them across every language sample. They live once in the repository-root [`/data`](../../data) directory.
